        ...
        <div class="card">
            <div class="card-header">
                <div class="col-sm-12 d-flex justify-content-end">
                    ...
                    <a class="btn btn-primary me-1 mb-1" data-bs-toggle="modal" data-bs-target="#addUsereditModal">{{ __('Add User') }}</a>
                        ...
                        <table class="table-light" aria-describedby="mydesc" class='table-striped' id="table_list"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" data-field="status" data-sortable="false" data-align="center">{{ __('Active Status') }}</th>
                                    <th scope="col" data-field="operate" data-sortable="false"
                                        data-events="actionEvents" data-align="center">{{ __('Action') }}</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
