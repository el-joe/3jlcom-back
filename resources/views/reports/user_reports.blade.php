                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row ">
                                <div class="col-md-6 col-12 ">
                                    <div class="col-md-12 col-12 form-group">
                                        <label for="title"
                                            class="form-label col-12">{{ __('Title') }}</label>
                                ...
                                <div class="col-md-6 col-12 ">
                                    <div class="row ">
                                        ...
                                        <div class="col-md-4 col-12 form-group">
                                            <label for="state"
                                                class="form-label col-12">{{ __('State') }}</label>
                                            <input class="form-control " placeholder="State" id="state" readonly
                                                type="text">
                                        </div>
                                        <div class="col-md-4 col-12 form-group">
                                            <label for="country"
                                                class="form-label col-12">{{ __('Country') }}</label>
                            ...
                            <div class="row ">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12 form-group">
                                            <label for="property_type"
                                                class="form-label col-12">{{ __('Property Type') }}</label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12 form-group">
                                            <label for="property_type"
                                                class="form-label col-12">{{ __('Rent Duration') }}</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12 form-group">
                                            <label for="client_address"
                                                class="form-label col-12">{{ __('Client Address') }}</label>
                            ...
                            <div class="row mt-1">
                                <div class="col-md-6 col-12">
                                    <label for="description"
                                        class="form-label col-12">{{ __('Title Image') }}</label>
                            ...
                            <label for="description"
                                class="form-label col-12">{{ __('Galllary Images') }}</label>
