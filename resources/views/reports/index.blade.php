                        ...
                        <form action="{{ route('report-reasons.store') }}" class="needs-validation" method="post"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label">{{ __('Reason Ar') }}</label> <span
                                            class="text-danger">*</span>
                                        <textarea name="reason_ar" class="form-control" placeholder={{ __('Reason Ar') }} required></textarea>
                                    </div>
                                </div>
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" data-field="reason" data-sortable="true">
                                                    {{ __('Reason') }}</th>
                                                <th scope="col" data-field="reason_ar" data-sortable="true">
                                                    {{ __('Reason Ar') }}</th>
                        ...
                        <div class="modal-body">
                            <form action="{{ url('report-reasons-update') }}" class="form-horizontal"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-6 ">
                                        <div class="form-group mandatory">
                                            <label for="edit_reason" class="form-label col-12">{{ __('Reason Ar') }}</label>

                                            <textarea name="edit_reason_ar" id="edit_reason" class="form-control" placeholder={{ __('Reason Ar') }} required></textarea>
...
@section('script')
    ...
    <script type="text/javascript">
        function setValue(id) {
            ...
            $("#edit_reason_ar").val($("#" + id).parents('tr:first').find('td:nth-child(3)').text());
        }
