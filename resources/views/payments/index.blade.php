                        ...
                        <table class="table-light" aria-describedby="mydesc" class='table-striped' id="table_list"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" data-field="transaction_id" data-align="center" data-sortable="false">
                                        {{ __('Transaction Id') }}
                                    </th>
                                    <th scope="col" data-field="payment_date" data-align="center" data-sortable="false">
                                        {{ __('Payment Date') }}
                                    </th>
                                    <th scope="col" data-field="payment_gateway" data-align="center" data-sortable="false">
                                        {{ __('Payment Gateway') }}
                                    </th>
