                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" data-field="offer" data-align="center" data-sortable="false">
                                        {{ __('Offer') }} </th>
                                    <th scope="col" data-field="inquiry_created" data-align="center" data-sortable="false">
                                        {{ __('Enquiries Posted') }} </th>
                                    <th scope="col" data-field="chat" data-align="center" data-sortable="false" data-visible="false" data-events="actionEvents1">
                                        {{ __('Chat') }} </th>
                                ...
                                <div class="col-sm-12 col-md-3">
                                    ...
                                    <div class="mr-3">
                                        <div class="custom-file">
                                            <input type="file" name="attachment" class="custom-file-input form-control" id="Homeattachment" />
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-6 col-12 ">
                            <div class="row ">
                                <div class="col-md-6 col-12 form-group">
                                    <label for="category"
                                        class="form-label col-12">{{ __('Category') }}</label>
                                    <input class="form-control " placeholder="{{ __('Category') }}" id="category" readonly type="text">
                                </div>
                                <div class="col-md-6 col-12 form-group">
                                    <label for="price"
                    ...
                    <div class="row ">
                        <div class="col-md-6 col-12">
                            <div class="row">
                                <div class="col-md-6 col-12 form-group">
                                    <label for="city"
                                        class="form-label col-12">{{ __('Manufacturer') }}</label>
                                    <input class="form-control " placeholder="{{ __('Manufacturer') }}" readonly="true" id="manufacturer" type="text">
                                </div>
                                <div class="col-md-6 col-12 form-group">
                                    <label for="area"
                                        class="form-label col-12">{{ __('Model') }}</label>
                                    <input class="form-control " placeholder="{{ __('Model') }}" readonly="true" id="model" type="text">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="row">
                                <div class="col-md-6 col-12 form-group">
                                    <label for="city"
                                        class="form-label col-12">{{ __('City') }}</label>
                                    <input class="form-control " placeholder="{{ __('City') }}" readonly="true" id="city" type="text">
                                </div>
                                <div class="col-md-6 col-12 form-group">
                                    <label for="area"
                                        class="form-label col-12">{{ __('Area') }}</label>
                                    <input class="form-control " placeholder="{{ __('Area') }}" readonly="true" id="area" type="text">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12 form-group">
                                    <label for="client_address"
                                        class="form-label col-12">{{ __('Description') }}</label>
                                    <textarea class="form-control " placeholder="{{ __('Description') }}" rows="2" id="description"
                                        cols="50" readonly></textarea>
                                </div>
                                <div class="col-md-6 col-12 form-group">
                                    <label for="address"
                                        class="form-label col-12">{{ __('Address') }}</label>
