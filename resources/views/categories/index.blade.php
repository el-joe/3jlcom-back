                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-12 form-group mandatory">
                                    {{ Form::label('category', __('Category'), ['class' => 'form-label text-center text-primary']) }}
                                    {{ Form::text('category', '', ['class' => 'form-control', 'placeholder' =>__('Category'), 'data-parsley-required' => 'true']) }}
                                </div>
        
                                <div class="col-md-4 col-sm-12 form-group mandatory">
                                    {{ Form::label('category_ar', __('Category Ar'), ['class' => 'form-label text-center text-primary']) }}
                                    {{ Form::text('category_ar', '', ['class' => 'form-control', 'placeholder' => __('Category Ar'), 'data-parsley-required' => 'true']) }}
                                </div>
        
                                <div class="col-md-4 col-sm-12 form-group mandatory">
                                    {{ Form::label('type', __('Facilities'), ['class' => 'form-label text-center text-primary']) }}
                                    ...
                                    <select data-placeholder="{{__('Choose Facilities')}}" name="parameter_type[]"
                                        ...
                                        <option value={{ $parameter->id }}>{{ $parameter->name_ar }}</option>
                                        @endforeach
                                    </select>
                                </div>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope="col" data-field="category" data-sortable="true" data-align="center">
                                    {{ __('Category') }}</th>
                                <th scope="col" data-field="category_ar" data-sortable="true" data-align="center">
                                    {{ __('Category Ar') }}</th>
                                <th scope="col" data-field="status" data-sortable="true" data-align="center">
                                    {{ __('Status') }}
                                </th>
                                <th scope="col" data-field="type" data-sortable="false" data-visible="false" data-align="center">
                                    {{ __('Type') }}
                                </th>
            ...
            <div class="modal-body">
                <form action="{{ url('categories-update') }}" class="form-horizontal" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group mandatory">
                                <label for="edit_category_ar" class="form-label col-12">{{ __('Category') }} ( AR )</label>
                                <input type="text" id="edit_category_ar" class="form-control col-12"
                                    placeholder="Name_ar" name="edit_category_ar" data-parsley-required="true">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 mandatory">
                            ...
                            <select data-placeholder="Facilities" name="edit_parameter_type[]" id="edit_parameter_type"
                                ...
                                @foreach ($parameters as $parameter)
                                <option value='{{ $parameter->id }}' id='op'>{{ $parameter->name_ar }}
                                </option>
                                @endforeach
                            </select>
                            @if (count($errors) > 0)
...
<script>
    function chk(checkbox) {
                ...
                $("#edit_parameter_type option:selected").each(function() {
                    ...
                    if (text_of_opt) {
                        $('#par').append($(
                            ...
                            '<div class="container1 form-control col-12 mb-2">' +
                            ' <div class = "content1"> ' +
        ...
        function setValue(id) {
            ...
            $("#edit_category_ar").val($("#" + id).parents('tr:first').find('td:nth-child(4)').text());
            $("#sequence").val($("#" + id).parents('tr:first').find('td:nth-child(9)').text());
