...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        if (!has_permissions('create', 'categories')) {
            ...
            $saveCategories->category_ar = ($request->category_ar) ? $request->category_ar : '';
            $saveCategories->manufacturer = ($request->manufacturer) ? $request->manufacturer : '0';
            $saveCategories->auction = ($request->auction) ? $request->auction : '0';
    ...
    public function update(Request $request)
    {
        ...
        if (!has_permissions('update', 'categories')) {
            ...
            if ($request->hasFile('edit_image')) {
                ...
                if (is_file(public_path('images') . config('global.CATEGORY_IMG_PATH') . $old_image)) {
            ...
            $Category->category_ar = ($request->edit_category_ar) ? $request->edit_category_ar : '';
    ...
    public function categoryList()
    {
        ...
        foreach ($res as $row) {
            ...
            $tempRow['category_ar'] = $row->category_ar;
