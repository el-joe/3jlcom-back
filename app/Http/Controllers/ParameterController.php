...
class ParameterController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        if (!has_permissions('update', 'type')) {
            ...
            $parameter->name_ar = ($request->edit_name_ar) ? $request->edit_name_ar : '';
    ...
    {
        parameter::where('id', $request->id)->update(['find' => $request->find]);
